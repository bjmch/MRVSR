...
# Data
Please download the proposed Quasi-Static Video Set and the standard Vid4 dataset from [here](https://drive.google.com/drive/folders/1mbndVeCqdBs-flk-Z_s-ISJZISNYZ8XN?usp=sharing). Please unzip and place them in the `data` folder. They are used in evalution.
# Pre-trained models
